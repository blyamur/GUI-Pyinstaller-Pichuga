...
# Copyright © 2022 Mons russian-spring <mons@mons.ws>

package require Tk 8.6

namespace eval ttk::theme::russian-spring-light {
    variable version 1.0
    package provide ttk::theme::russian-spring-light $version

    ttk::style theme create russian-spring-light -parent clam -settings {
        ...
        # Button
        ttk::style configure TButton -padding {8 4} -anchor center -foreground #0D0C08

        ttk::style map TButton -foreground \
            [list disabled #0D0C08 \
                pressed #40BFA9 \
                active #0D0C08]
        ...
        # Accent.TButton
        ttk::style configure Accent.TButton -padding {8 4} -anchor center -foreground #FFF
        ...
        # Url.TButton
        ttk::style configure Url.TButton -padding {8 4} -anchor center -foreground #A0B6B6

        ttk::style map Url.TButton -foreground \
            [list disabled #AB4338 \
                pressed #40BFA9]
